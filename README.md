...
- **Add categories**
- **Add expence on a given category**
...
- [Live Demo Link](https://matumizi.onrender.com/)
...
```sh
  cd my-folder
  git clone https://github.com/GordonOtieno/expence-tracker.git
```
-
...
If you like this project please give it a star and follow me on my github page.
